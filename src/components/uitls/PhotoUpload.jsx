    ...
    const handleUpload = async () => {
        ...
        try {
            ...
            if (!isCompleteFailed && isSomeFailed)
                toast.error("Some files could not be uploaded", toastErrorStyle()); // if some files couldnt be uploaded
            else if (!isCompleteFailed && !isSomeFailed)
                toast.success("Files successfully uploaded", toastSuccessStyle()); // if all files are uploaded
        }
    ...
    return (
        ...
        <div className='mainBody'>
            ...
            <div className='wrapper'>
                <header>Upload the photos</header>
                <form>
